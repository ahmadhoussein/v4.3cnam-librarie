      ...
      if(isset($_COOKIE['Email']) || isset($_SESSION['Email'])){
        $favTXT ="
          <form method='post' id='form-fav'>
            ...
            <button type='button' name='addfav' onclick='addFavorite()'>
              <svg width='24px' height='24px' viewBox='0 0 24 24' fill='none'>
                
                <!-- to change border color, change the stroke value, for the background, change the fill (to red when user favors it) -->
...
function afficherCommentaires($query)
{
  ...
  if(isset($_COOKIE['Email']) || isset($_SESSION['Email'])){
    echo ("
      <div class='container'>
      <section id='comments'>
      <form action='./comment.php' method='get' id='form-comment'>
